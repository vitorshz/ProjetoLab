...
public class MedicoFrame1 extends javax.swing.JFrame {
     private MaskFormatter mfdata,mfcpf,mfcelular,mfCRM;

    
private Medico medicoAtual; 

public MedicoFrame1() throws ParseException {
    try {
...
@SuppressWarnings("unchecked")
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new MedicoFrame1().setVisible(true);
                } catch (ParseException ex) {
                    Logger.getLogger(MedicoFrame1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
